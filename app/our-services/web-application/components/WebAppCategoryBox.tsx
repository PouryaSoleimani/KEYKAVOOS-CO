    ...
    return (
        <div className='w-[90%] glass h-auto lg:h-[30rem] mx-10 p-6 gap-y-4 rounded-2xl border border-zinc-400 bg-transparent shadow-xl shadow-zinc-400 flex flex-col lg:flex-row items-center justify-between text-3xl px-6' dir='rtl'>
            ...
            <div id='RIGHT' className='flex flex-col items-center lg:items-start justify-center lg:justify-start gap-6 w-full lg:w-1/2 h-full lg:p-6'>
                ...
                <div id="RIGHT__PRICE" className='flex items-center justify-start flex-col lg:flex-row flex-wrap w-full gap-4 lg:gap-5'>
                    <span className='btn btn-outline btn-lg w-full lg:w-auto'>
                        <FaMoneyBillWave />
                        از 20.000.000 تومان
                    </span>
                    <span className='btn btn-outline btn-lg text-lg lg:text-2xl w-full lg:w-fit flex flex-wrap'>
                        <FaWordpress />
                        <IoLogoJavascript />
                        <FaReact />
                        <RiNextjsFill />
                ...
                <div id="RIGHT__BUTTONS" className='flex gap-4 flex-col lg:flex-row items-center justify-center lg:justify-start w-full'>
                    <button className='btn w-full lg:w-auto btn-primary bg-gradient-to-tr from-blue-500 via-[#4866CF] to-blue-900 border-none outline-none  text-lg font-thin tracking-tight shadow-sm shadow-zinc-300 hover:scale-110 duration-500'>مشاهده نمونه کارها</button>
                    <button className='btn w-full lg:w-auto bg-gradient-to-tr from-lime-500 via-[#0dbe66] to-emerald-500 border-none outline-none text-white text-lg font-thin tracking-tight shadow-sm shadow-zinc-300 hover:scale-110 duration-500 '>ثبت سفارش</button>
                    <button className='btn w-full lg:w-auto bg-gradient-to-tr from-yellow-500 via-orange-400 to-red-600 border-none outline-none text-white text-lg font-thin tracking-tight shadow-sm shadow-zinc-300 hover:scale-110 duration-500 '>مشاوره آنلاین</button>
                </div>
            </div>

            <div className="divider divider-horizontal py-10"></div>
