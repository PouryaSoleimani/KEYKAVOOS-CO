...
const GraPhicDesignPage: NextPage<Props> = ({ }) => {
    ...
    return (
        <div className='web-container overflow-x-hidden'>
            <Nav />
            {/* HEADER */}
            ...
            <video src="/GRAPHIC__DESIGN/1.mp4" loop autoPlay height={100} className='h-80 w-[90%] mx-auto my-10' />
            {/* CAROUSEL */}
            ...
            <p className='mt-10 text-center p-6 bg-gradient-to-tr from-blue-200/30 via-[#4877cf30] to-blue-900/30 rounded-2xl shadow-lg shadow-zinc-400 flex flex-col items-center justify-center gap-y-2'>
                ...
                <span className='text-center text-md font-extralight leading-9'>
                    طراحی گرافیک شامل طیف وسیعی از خدمات است که هر کدام به نیازهای خاص مشتریان پاسخ می‌دهند. در زیر به انواع خدمات طراحی گرافیک با جزئیات بیشتری پرداخته‌ام:
                </span>
            </p>
            <Footer />
        </div>
