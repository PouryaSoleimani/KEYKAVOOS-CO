      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-[5%]">
        ...
        <div className="flex flex-col gap-10 mt-10">
          <div className="self-center">
            <Image src={userProfile.pic_path ? `http://localhost:8000/storage/${userProfile.pic_path}` : `/USER__DEFAULT.png`} alt="profile_pic" width={162} height={152} className="flex items-center justify-center text-zinc-500 rounded-full" />
          </div>
