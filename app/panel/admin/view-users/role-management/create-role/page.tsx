    ...
    <div className="bg-white shadow mx-auto rounded-2xl w-full p-[3%] space-y-3 flex flex-col gap-5">
      ...
      <form onSubmit={(e) => handleSubmission(e)} className="flex flex-col gap-3"      >
        ...
        <input
          ...
          onChange={(e) => setCreateRole((last) => ({ ...last, name_en: e.target.value }))}
          className="bg-[#D0DBEC]  mx-auto outline-none rounded-md px-2 py-3 text-lg font-thin text-zinc-700 tracking-tight w-full border-[0.3px]"
        />
        ...
        <input
          ...
          onChange={(e) => setCreateRole((last) => ({ ...last, name_fa: e.target.value }))}
          className="bg-[#D0DBEC]  mx-auto outline-none rounded-md px-2 py-3 text-lg font-thin text-zinc-700 tracking-tight w-full border-[0.3px]"
        />
