            ...
            <div className="flex justify-center items-center gap-4">
              {status !== "success" ? (
                ...
                <div className="bg-[#EAEFF6] rounded-full">
                  <Image alt="profile" src={`http://localhost:8000/storage/${userProfile.pic_path}`} className="rounded-full flex items-center justify-center text-[10px] text-zinc-500" width={30} height={30} />
                </div>
              ) : (
