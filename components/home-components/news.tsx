...
function News() {
  ...
  return (
    ...
    >
      <p className="text-[#334052] sm:text-[36px] font-extrabold py-4 max-w-lg text-center text-[30px] tracking-tighter" >
      ...
      <div className="bg-[#F8FAFC] sm:w-[400px] flex flex-row rounded-2xl shadow-md shadow-zinc-400 p-0 ">
        <button className="bg-zinc-600 text-white w-[130px] m-0 py-3 rounded-l-2xl hover:text-white hover:bg-[#4866CF] duration-300" type="submit"  >
          تایید ایمیل
        </button>
