...
function PlanCard({ data }: PlanCardProps) {
  ...
  return (
    <>
      <div className="relative bg-transparent shadow-lg shadow-zinc-700 backdrop-blur-[2px] p-[3%] rounded-xl w-[250px] md:max-lg:w-[260px] cursor-pointer hover:scale-105 duration-300">
