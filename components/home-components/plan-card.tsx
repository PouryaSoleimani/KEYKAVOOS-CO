...
function PlanCard({ data }: PlanCardProps) {
  ...
  return (
    <>
      <div className="bg-zinc-300/30 backdrop-blur-[7px] w-[250px] md:max-lg:w-[260px] rounded-xl p-[3%] relative shadow hover:scale-105 duration-300 cursor-pointer">
        <div className="bg-[#4866CF] w-[99%] mx-auto text-center text-[18px] font-semibold text-white rounded-t-xl tracking-tighter absolute z-10 -translate-x-1/2 left-1/2 -top-[0.04rem] p-2">
          {data.type}
        </div>
        <div className="border border-[#4866CF] rounded-xl">
          <div className="p-[3%] mt-[18%] flex flex-col gap-5">
            <p className="text-center text-[#68707A]  tracking-tighter" data-aos="zoom-in" data-aos-duration="1500" >{data.title}</p>
            <div className="flex flex-col gap-3 justify-center items-center" data-aos="zoom-in" data-aos-duration="1500">
