...
function TechnologyCard({ technologyInfo }: TechnologyCardProps) {
  return (
    <div className="bg-white h-[400px] md:max-lg:h-[300px] w-[260px] lg:w-full mx-auto shadow-md rounded-[15px] flex flex-col items-center gap-3 hover:scale-105 duration-300 cursor-pointer">
      ...
      <ul className="flex flex-col items-center w-full gap-5 py-4">
        {technologyInfo.technologies.reverse().map(
