    ...
    return (
        <div className='flex bg-transparent flex-col-reverse p-10 backdrop-blur-[2px] border border-zinc-300 shadow-md shadow-zinc-400 rounded-2xl lg:flex-row justify-between items-center  lg:h-fit'>
            ...
            <div id="RIGHT" className='flex flex-col justify-start items-start space-y-4  py-2 w-full lg:w-1/2 h-full' dir='rtl' data-aos="fade-left" data-aos-duration="1500">
                ...
                <div className='text-zinc-600 tracking-tighter text-justify text-md leading-8 lg:leading-9 font-thin whitespace-pre-line '><b className='font-bold tracking-wide text-zinc-800 my-3'>طراحی سایت با وردپرس مزایای زیادی دارد، از جمله : </b>
                    <br />
