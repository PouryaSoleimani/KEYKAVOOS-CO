...
const WordPress: NextPage<Props> = ({ }) => {
    return (
        <div className='flex flex-col-reverse px-4 py-16 backdrop-blur-[3px] shadow-md shadow-zinc-950 rounded-2xl lg:flex-row justify-between items-center my-16 w-full h-full lg:h-[600px] bg-transparent'>
            ...
            <div id="RIGHT" className='flex flex-col justify-start items-start space-y-8 px-6 py-2 w-full lg:w-1/2 h-full' dir='rtl' data-aos="fade-left" data-aos-duration="1500">
                ...
                <p className='text-zinc-300 tracking-tighter text-justify text-lg font-thin whitespace-pre-line'><b className='font-bold tracking-wide text-white my-3'>طراحی سایت با وردپرس مزایای زیادی دارد، از جمله:</b>
                    <br />
                    ...
                    <br />
                    پشتیبانی گسترده: جامعه بزرگ کاربران و توسعه‌دهندگان به راحتی به مشکلات پاسخ می‌دهند.
                    <br />
                    سئو دوستانه: ابزارهای قدرتمند برای بهینه‌سازی موتورهای جستجو (SEO) به راحتی در دسترس است.
