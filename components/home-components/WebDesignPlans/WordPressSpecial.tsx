...
const WordPressSpecial: NextPage<Props> = ({ }) => {
    return (
        <div className='flex bg-transparent flex-col-reverse px-7 py-3 space-x-4 backdrop-blur-[2px] border border-zinc-300 shadow-md shadow-zinc-400 rounded-2xl lg:flex-row-reverse justify-between items-center w-full h-full lg:h-fit'>
            ...
            <div id="LEFT" className={`w-full bg-contain lg:bg-cover lg:w-1/2 h-full leftWordPress z-30 flex items-start justify-start ml-16`} data-aos="fade-right" data-aos-duration="1500">
                <Image src='/Technology/wordpress.svg' alt='wordpress-logo' width={120} height={120} className='wordPress3D absolute right-2' />
