...
const OurServices = () => {
    return (
        <>
            ...
            <div className='grid grid-cols-2 place-items-center lg:flex justify-around items-start py-16 gap-4 px-[4vw]  w-full lg:h-[500px] text-zinc-200' dir='rtl' data-aos="fade-up" data-aos-duration="1500">
