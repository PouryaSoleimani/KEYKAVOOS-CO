...
const OurServices = () => {
    return (
        <>
            ...
            <section className='grid grid-cols-1 sm:grid-cols-2 sm:gap-y-10 sm:place-items-stretch lg:flex  place-items-stretch px-10 justify-around items-start py-16 gap-4 w-full lg:h-[500px] text-zinc-800' dir='rtl' data-aos="fade-up" data-aos-duration="1500">
