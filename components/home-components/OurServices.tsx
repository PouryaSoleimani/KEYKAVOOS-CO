...
const OurServices = () => {
    return (
        <>
            ...
            <section className='grid grid-cols-1 sm:grid-cols-2 sm:grid-rows-3 sm:gap-16 sm:place-items-stretch lg:px-10 lg:flex flex-wrap  place-items-stretch px-10 justify-center items-start py-16 gap-4 w-full lg:h-[900px] lg:my-16 text-zinc-800' dir='rtl' data-aos="fade-up" data-aos-duration="1500">
                <div className="servicecard hover:scale-110 duration-300 cursor-pointer z-10 backdrop-blur-[10px] bg-white shadow-md flex items-center justify-center shadow-zinc-300 rounded-2xl border border-zinc-300 text-center">
