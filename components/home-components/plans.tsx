...
function Plans() {
  return (
    <div className={`relative flex flex-col animate__animated animate__delay-3s animate__fadeInUp animate__slow px-4 py-16 ${styles.plansContainer} `} id="PLANS__CONTAINER" >
