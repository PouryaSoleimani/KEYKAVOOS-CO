...
const Nav = () => {
  ...
  return (
    <div
      className={`w-full mx-auto top-0 z-[999] font-YekanBakh transition-all sticky mb-3 rounded-xl lg:${activeColorChange && "shadow-md bg-white/25 backdrop-blur-3xl rounded-xl"}`}
      onMouseLeave={() => (
        setShowOne(false),
        setShowTwo(false),
        setShowThree(false),
    ...
    >
      <div className="flex justify-between items-center h-[5rem] md:h-[5rem] mx-auto shadow-md px-[10%] rounded-b-lg backdrop-blur-3xl bg-white/25">
        {/* Mobile */}
        <NavMobile
          active={active}
          setActive={setActive}
