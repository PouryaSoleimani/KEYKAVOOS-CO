...
const Nav = () => {
  ...
  return (
    <div
      className={`w-full mx-auto top-0 z-[999] font-YekanBakh transition-all sticky mb-3 rounded-xl lg:${activeColorChange && "shadow-md bg-zinc-50/50 backdrop-blur-2xl rounded-xl"}`}
      onMouseLeave={() => (
        setShowOne(false),
        setShowTwo(false),
        setShowThree(false),
