    ...
    <div className="flex flex-col gap-2 items-stretch justify-center lg:justify-start lg:gap-6">
      ...
      <form className="flex gap-2 flex-col lg:flex-row" onSubmit={handleSubmit(onSubmit)} >
        <div className="w-full">
          ...
          {errors.email && <p className='text-red-900 bg-red-200/40 font-thin px-2 py-0.5 rounded-md absolute top-36 right-[3%] tracking-tighter text-sm'>ایمیل وارد شده صحیح نمی باشد</p>}
        </div>
