  ...
  return (
    <div className="flex flex-col justify-stretch gap-3 col-span-2">
      ...
      <div className="flex flex-row items-center gap-2 mt-1">
        <Image src="/footer/location.svg" alt="location" className="w-7 h-7 ml-1" />
      ...
      <div className="flex flex-row items-center gap-2 mt-1">
        <Image src="/footer/phone.svg" alt="phone" className="w-6 h-6 -rotate-12" />
    ...
    <div className="flex flex-col gap-3 col-span-2">
      ...
      <div className="flex justify-center py-2 items-center">
        <Link referrerPolicy="origin" target="_blank" href="https://trustseal.enamad.ir/?id=422622&Code=KGdskS8BDuEuvxkxW9GT5eCCOJ3TO3sa">
          <Image src="/footer/senfi.svg" alt="senfi-logo" className="w-[5em]" />
        </Link>
        <Link href="https://enamad.ir/" target="_blank">
          <Image src="/footer/enamaad.svg" alt="enamaad-logo" className="w-[5em]" />
        </Link>@
      </div>
    </div>
  );
